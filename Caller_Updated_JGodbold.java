...
class	Caller
{
            ...
            NumberFormatException
    {
        ...
        setSessionCookie(cookie); //  CHANGE THAT empty string!
            ...
            throws IOException
    {
        ...
        String	url		= getUrlPrefix()	+
                "/kb/"		+
                kbId			+
                "/noSaveClose?name=JaydenGodbold";
    ...
    int		run		()
    {
        ...
        catch  (JSONException | NumberFormatException | IOException error)
        {
